...
subroutine phys_register
    ...
    use prescribed_wv,      only: prescribed_wv_register
...
subroutine phys_init( phys_state, phys_tend, pbuf2d, cam_out )
    ...
    use prescribed_wv,      only: prescribed_wv_init
...
!-----------------------------------------------------------------------------------
  ...
  use prescribed_wv,       only: prescribed_wv_adv
  ...
  call prescribed_wv_adv(phys_state, pbuf2d)
