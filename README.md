...
# Getting started
You need to be able to run the CESM model and get access to the radiation code. 

# Codes
Includes the radiation codes written in Fortran (physpkg.F90; prescribed_wv.F90; radiation.F90). These codes are modified based on the origional codes from CESM. restart_physics.F90 is the code I write to read the water vapor content from the control run. 
